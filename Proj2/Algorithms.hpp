...
class Algorithms {
    public:
        ...
        static vector<int> customTspHeuristic(const vector<vector<float>>& distances, const float& clusteringEpsilon, const int& clusteringMinPts, float& resultCost);
        ...
        static vector<int> nearestNeighborClusterRoute(const int& initialCity, const vector<vector<float>>& distances, float& tourCost, const vector<int>& route, const unordered_map<int, float>& repToClusterCosts);

        static void rotateCycle(vector<int>& cycle, const int& start);
        ...
        static vector<int> multiStartTwoOptNearestNeighbor(float& cost, const vector<vector<float>>& distances, const int& numOfStarts, const vector<int>& cluster = {}, const unordered_map<int, float>& repToClusterCosts = {});
        ...
        static int findNearestNeighborClusterRoute(const int& city, const vector<vector<float>>& distances, vector<bool>& visited, const vector<int>& route, const unordered_map<int, float>& repToClusterCosts);
