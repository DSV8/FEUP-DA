...
void Manager::goBackToCustomMenu() {
    string input;

    while (input != "V" && input != "v") {
        cinReset();
        cout << "\nPress v or V to go back to the previous Menu: ";
        cin >> input;
    }
    cinReset();
        ...
        switch (optionInt) {
            ...
            case 4:
                ...
                while(true){
                    ...
                    if (optionStr3 == "v" or optionStr3 == "V")
                        break;

                    try {
                        optionInt3 = stoi(optionStr3);
                    } catch (const invalid_argument& e) {
                        cout << "\nYOU CAN NOT INPUT TEXT OTHER THAN 'v' or 'V'" << endl;
                        cinReset();
                        continue;
                    ...
                    switch(optionInt3){
                        case 1:
                            cout << "\nREAL GRAPH 1" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(realGraph1, 500, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 2:
                            cout << "\nEDGES 25" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_25, 11100, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 3:
                            cout << "\nEDGES 50" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_50, 25100, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 4:
                            cout << "\nEDGES 75" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_75, 4400, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 5:
                            cout << "\nEDGES 100" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_100, 5000, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 6:
                            cout << "\nEDGES 200" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_200, 2900, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 7:
                            cout << "\nEDGES 300" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_300, 2800, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 8:
                            cout << "\nEDGES 400" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_400, 2500, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 9:
                            cout << "\nEDGES 500" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_500, 2600, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 10:
                            cout << "\nEDGES 600" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_600, 1800, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 11:
                            cout << "\nEDGES 700" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_700, 1600, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 12:
                            cout << "\nEDGES 800" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_800, 1000, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        case 13:
                            cout << "\nEDGES 900" << endl;
                            cout << string(80, '-') << endl;
                            customHeuristic(edges_900, 1700, 2);
                            cout << string(80, '-') << endl;
                            goBackToCustomMenu();
                            break;
                        default:
...
void Manager::customHeuristic(const Graph &graph, const float& eps, const int& minPts) {
    vector<vector<float>> distances = graph.getAdjMatrix();
    ...
    auto start = high_resolution_clock::now();
    float tourCost;
    vector<int> tspSolution = Algorithms::customTspHeuristic(distances, eps, minPts, tourCost);
    auto end = high_resolution_clock::now();

    duration<double, milli> msExecTime = end - start;

    Algorithms::rotateCycle(tspSolution, 0);

    for (const int& node : tspSolution) {
        cout << node << "->";
    }

    cout << "\nTour Length: " << tourCost << " meters" << endl;
